...
from models.hifidiffv18r11 import HifiDiffV18R11
from models.hifidiffv18r12 import HifiDiffV18R12
from models.hifidiffv18r13 import HifiDiffV18R13
from models.hifidiffv18r14 import HifiDiffV18R14
from models.hifidiffv18r15 import HifiDiffV18R15
from models.hifidiffv18r16 import HifiDiffV18R16
from models.hifidiffv18r17 import HifiDiffV18R17
from models.hifidiffv18r18 import HifiDiffV18R18
from models.hifidiffv18r19 import HifiDiffV18R19
from models.hifidiffv18r20 import HifiDiffV18R20
from models.hifidiffv18r21 import HifiDiffV18R21
from models.hifidiffv18r22 import HifiDiffV18R22
from models.hifidiffv18r23 import HifiDiffV18R23
...
def build_model(params):
    ...
    elif params.model == 63:
        model = HifiDiffV18R11(params)
    elif params.model == 64:
        model = HifiDiffV18R12(params)
    elif params.model == 65:
        model = HifiDiffV18R13(params)
    elif params.model == 66:
        model = HifiDiffV18R14(params)
    elif params.model == 67:
        model = HifiDiffV18R15(params)
    elif params.model == 68:
        model = HifiDiffV18R16(params)
    elif params.model == 69:
        model = HifiDiffV18R17(params)
    elif params.model == 70:
        model = HifiDiffV18R18(params)
    elif params.model == 71:
        model = HifiDiffV18R19(params)
    elif params.model == 72:
        model = HifiDiffV18R20(params)
    elif params.model == 73:
        model = HifiDiffV18R21(params)
    elif params.model == 74:
        model = HifiDiffV18R22(params)
    elif params.model == 75:
        model = HifiDiffV18R23(params)
